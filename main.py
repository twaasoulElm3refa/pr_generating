...
async def generate_article(user_id: str):
    ...
    if not all_release:
      ...
      5.	جسم البيان (Body)
      الفقرة الرابعة: تفاصيل إضافية (بيانات، أرقام، شراكات، أمثلة).
      6.	نبذة عن الجهة (Boilerplate)
      المحتوى: تعريف موجز بالجهة (متى تأسست، نشاطها الرئيسي، إنجاز رئيسي، الحضور الجغرافي).
      الطول: لا يتجاوز 4 أسطر.
