...
async def generate_article(user_id: str):
    ...
    if not all_release:
      ...
      الهيئة القياسية:
      [المدينة] – [التاريخ الكامل بصيغة يوم/شهر/سنة]
      مثال:
      الرياض – 5 مايو 2025
      ...
      الفقرة الثالثة: اقتباس رسمي من المتحدث باسم الجهة (رئيس، مدير، متحدث إعلامي).
      يجب أن يكون الاقتباس طبيعيًا، بشريًا، وليس تكرارًا لما سبق.
      الفقرة الرابعة: تفاصيل إضافية (بيانات، أرقام، شراكات، أمثلة).
      الفقرة الخامسة – اختياري: اقتباس إضافي من جهة شريكة، عميل، أو مسؤول آخر.
      6.	نبذة عن الجهة (Boilerplate)
      الموقع: قبل السطر الأخير تمامًا.
      ...
      الاسم الكامل لمسؤول التواصل
      الوظيفة
      البريد الإلكتروني الرسمي
      رقم الهاتف المباشر أو خط المتحدث الإعلامي
